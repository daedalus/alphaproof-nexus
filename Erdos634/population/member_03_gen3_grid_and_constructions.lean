...
/-
  Population Member 03: Strategy = Grid cardinality + Soifer constructions
  Approach: Complete the grid_card proof from member 02 (proving squares
    are tilable); add an explicit equilateral grid-tiling construction.
    Outline Soifer's 2k² and 3k² constructions with concrete dissections.
